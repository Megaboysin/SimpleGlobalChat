    ...
    private void sendHelp(CommandSender sender, String langKey, int page) {
        ...
        if (sender instanceof Player player && totalPages > 1) {
            ...
            if (page > 1) {
                ...
                prev.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/chathelp " + (page - 1)));
            ...
            if (page < totalPages) {
                ...
                next.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/chathelp " + (page + 1)));
